...
@router.get("/api/support/bot-version")
...
@router.post("/api/auth/verify-registration")
...
@router.post("/api/account/presence")
...
@router.post("/api/account/experience", status_code=201)
...
@router.put("/api/account/experience/{experience_id}")
...
@router.delete("/api/account/experience/{experience_id}")
...
@router.post("/api/account/education", status_code=201)
...
@router.put("/api/account/education/{education_id}")
...
@router.delete("/api/account/education/{education_id}")
...
@router.post("/api/account/resume-builder", status_code=201)
...
@router.post("/api/account/documents", status_code=201)
...
@router.delete("/api/account/documents/{document_id}")
...
@router.post("/api/admin/job-assignments", status_code=201)
...
@router.post("/api/jobs/{job_id}/apply", status_code=201)
...
@router.post("/api/admin/application-shares", status_code=201)
...
@router.post("/api/admin/user-shares", status_code=201)
...
@router.post("/api/agent/jobs", status_code=201)
...
@router.patch("/api/agent/applications/{application_id}")
...
@router.get("/api/agent/interviews")
...
@router.patch("/api/agent/interviews/{interview_id}")
...
@router.post("/api/agent/interviews", status_code=201)
...
@router.post("/api/admin/users/{user_id}/documents", status_code=201)
...
@router.post("/api/admin/jobs", status_code=201)
...
@router.patch("/api/admin/jobs/{job_id}")
...
@router.patch("/api/admin/interviews/{interview_id}")
...
@router.post("/api/admin/interviews", status_code=201)
...
@router.post("/api/support/messages/clear")
...
@router.delete("/api/support/messages")
